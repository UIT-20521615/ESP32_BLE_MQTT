...
#define SAMPLE_DEVICE_NAME          "LOP 1 - NHOM 6"
...
static char ble_data[16];
static uint8_t mqtt_data[16];
bool written = false;
...
static const uint8_t char1_name[]  = "DATA";
//static const uint8_t char_value[16];
...
static esp_gatts_attr_db_t gatt_db[HRS_IDX_NB] =
{
    ...
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&CHAR_1_SHORT_WR, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE | ESP_GATT_PERM_READ_ENC_MITM,
      SHORT_CHAR_VAL_LEN, sizeof(mqtt_data), (uint8_t *) &mqtt_data}},
...
esp_ble_gatts_cb_param_t *param_global;
    ...
    switch (event) {
        ...
        case ESP_GATTS_WRITE_EVT:
            ...
            if (!param->write.is_prep){
                ...
                ESP_LOGI(EXAMPLE_TAG, "***** write success ***** \n");
                if (gatt_db_handle_table[IDX_CHAR_VAL_A] == param->write.handle) {
                    ESP_LOGI(EXAMPLE_TAG, "Please input some data: \n");
                    memcpy(ble_data, (char*) param->write.value, 16);
                    written = true;
                }
...
static esp_err_t mqtt_event_handler_cb(esp_mqtt_event_handle_t event)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        esp_mqtt_client_subscribe(client, "lop1_nhom6", 0);
        esp_mqtt_client_publish(client, "lop1_nhom6/status", "ESP32 Connected!", 0, 1, 0);
        break;
...
void mqtt_event_message(char * topic, char * message) {
...
static void mqtt_app_start(void)
{
    esp_mqtt_client_config_t mqtt_cfg = {
        ...
        .credentials.username = "QENyqM2vEkwaqBFK34HBgJUE34or2ozJQd57NYqf8MfmbJU3DruKYceP6s7XEuwk",
...
void app_main(void)
{
    ...
    char old_ble_data[16];
    memcpy(old_ble_data, ble_data, 16);
    while (1) {
        if(old_ble_data != ble_data && written == true) {
            mqtt_event_message("lop1_nhom6", ble_data);
            memcpy(old_ble_data, ble_data, 16);
            written = false;
        }
        if(subcribed == true) {
